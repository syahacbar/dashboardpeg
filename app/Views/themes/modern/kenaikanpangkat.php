...
<div class="card">
  <div class="card-header">
    ...
    <div class="tab-content" id="myTabContent">
      ...
      <div class="tab-pane fade" id="tab-fungsionalumum" role="tabpanel" aria-labelledby="tab-fungsionalumum" tabindex="0">...</div>

      <div class="tab-pane fade" id="tab-fungsionaltertentu" role="tabpanel" aria-labelledby="tab-fungsionaltertentu" tabindex="0">...</div>
